...
export default function ProductEdit({ brands = [], categories = [], subcategories = [], dataExists }) {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        colors: Array.isArray(dataExists.colors) ? dataExists.colors : [],
        sizes: Array.isArray(dataExists.sizes) ? dataExists.sizes : [],
        category: {
    ...
    const handleQuill = (value) => setData('description', value);

    const handleSelect = (name, value) => setData(name, value);
    ...
    // Handler untuk input array (colors & sizes)
    ...
    const handleSubmit = (e, type) => {
        e.preventDefault();
        post(route('product.update', dataExists.id));
    };
    ...
    return (
        ...
        >
            <Head title="Form Edit Product" />

            <form onSubmit={(e) => handleSubmit(e, data.type)}>
                        ...
                        <div className="flex-1 flex flex-col gap-6">
                            ...
                            <div className="bg-white rounded shadow p-6">
                                ...
                                <div>
                                    ...
                                    <div className="mb-3 border rounded resize-y overflow-hidden h-full">
                                        <ReactQuill
                            ...
                            <div className="bg-white rounded shadow p-6">
                                ...
                                <div className="mb-4">
                                    ...
                                    <input
                                        ...
                                        value={data.fixPrice}
                                        readOnly
                                        className="w-full border rounded px-3 py-2 bg-gray-100 border-gray-300"
                                    />
                                </div>
                                <div>
