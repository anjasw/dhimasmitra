...
export default function ProductAdd({ brands = [], categories = [], subcategories = [], colors = [], sizes = [] }) {
    // Menggunakan useForm
    ...
    const handleSubmit = (e, type) => {
        ...
        post(route('product.store')); // Langsung panggil post() dari useForm
                        ...
                        <div className="flex-1 flex flex-col gap-6">
                            ...
                            <div className="bg-white rounded shadow p-6">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {data.images.map((img, idx) => ( // Gunakan data.images
